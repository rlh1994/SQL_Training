...
/*21- Write a query to return the 15 oldest planes from the PLANE table. Include any extra ties if there are.*/

/*22- Write a query to return the top 5% of planes from the PLANE table with the most number of seats.*/

/*23- Create queries using the dual table to generate:
...
/*24- Take your answer from question 7 and by nesting the table filter the results to just those records with precipitation above 
0.2cm of rain and temperature above 20 degrees celcius.*/

/*25- Take your answer from question 9 and using the WITH caluse filter the results to records with Mist or Haze*/

/*26- Take your answer from question 11 and using whichever method you prefer filter to just records with 'lines' somewhere
